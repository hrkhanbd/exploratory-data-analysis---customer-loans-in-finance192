...
print("Columns after transformations:", transformed_df.columns)
...
print("Columns after dropping missing values:", cleaned_df.columns)

# Impute missing values intelligently
imputed_df = df_transform.intelligent_impute_missing_values(skew_threshold=1)
print("Columns after imputing missing values:", imputed_df.columns)
...
print("Columns after removing outliers:", df_no_outliers.columns)
...
essential_columns = ['funded_amount', 'total_rec_prncp']
highly_correlated_columns = [col for col in highly_correlated_columns if col not in essential_columns]

print("Columns before removing highly correlated columns:", cleaned_df.columns)
cleaned_df_no_correlated = correlation_analysis.remove_highly_correlated_columns(highly_correlated_columns)
print("Columns after removing highly correlated columns:", cleaned_df_no_correlated.columns)
